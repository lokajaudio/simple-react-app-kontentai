...
import { englishCode, spanishCode, czechCode } from '../Utilities/LanguageCodes';
                ...
                <div className="container">
                    <nav>
                        <ul>
                            ...
                            <li>
                                <Link to={`/${language}/template`}>
                                    {formatMessage({ id: 'Header.dummyButton' })}
                                </Link>
                            </li>
                        </ul>
                    </nav>
                            ...
                            <ul className="dropdown-items-list dropdown-desktop-visible">
                                ...
                                <li>
                                    <a
                                        ...
                                        onClick={(e): void => {
                                            e.preventDefault();
                                            window.location.pathname.endsWith('o-nas')
                                                ? props.changeLanguage(
                                                    englishCode, '/about-us')
            ...
            <div className="header-row">
                <div className="container">
                    <div className="col-xs-8 col-md-8 col-lg-4 logo">
                        <h1 className="logo">
                            <Link to={`/${language}`} className="logo-link">Dancing Goat</Link>
                            </h1>
                </div>
            </div>
        </div>
